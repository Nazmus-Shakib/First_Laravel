                    ...
                    <form method="post" action="{{ route('sliders.update',$editData->id) }}" id="myForm" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                <img src="{{(!empty($editData->image)) ? url('public/upload/slider_images/'.$editData->image) : url('public/upload/no-image.png')}}" alt="" style="width: 150px; height: 160px; border: 1px solid black;" id="showImage">
                            </div>
