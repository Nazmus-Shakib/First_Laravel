              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$key + 1}}</td>
                            <td><img src="{{(!empty($mission->image)) ? url('public/upload/mission_images/'.$mission->image) : url('public/upload/no-image.png')}}" alt="" width="100px" height="100px">
                            </td>
                            <td>{{ $mission->title }}</td>
                            <td>
                                <a title="Edit" class="btn btn-secondary btn-sm" href="{{route('missions.edit', $mission->id)}}"><i class="fa fa-edit"></i></a>
